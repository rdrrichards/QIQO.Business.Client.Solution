...
{
	public partial class RepresentativeWrapper : ModelWrapperBase<Representative>
	{
		public RepresentativeWrapper(Representative model) : base(model)
		{
		}

	public System.Int32 ParentEmployeeKey
	{
		get { return GetValue<System.Int32>(); }
		set { SetValue(value); }
	}

	public System.Int32 ParentEmployeeKeyOriginalValue => GetOriginalValue<System.Int32>(nameof(ParentEmployeeKey));

	public bool ParentEmployeeKeyIsChanged => GetIsChanged(nameof(ParentEmployeeKey));
	...
	public ChangeTrackingCollection<AccountWrapper> Accounts { get; private set; }
 
	public ChangeTrackingCollection<CompanyWrapper> Companies { get; private set; }
	...
	protected override void InitializeComplexProperties(Representative model)
	{
	...
	protected override void InitializeCollectionProperties(Representative model)
	{
		...
		Accounts = new ChangeTrackingCollection<AccountWrapper>(model.Accounts.Select(e => new AccountWrapper(e)));
		RegisterCollection(Accounts, model.Accounts);

		if (model.Companies == null)
		{
			throw new ArgumentException("Companies cannot be null");
		}
 
		Companies = new ChangeTrackingCollection<CompanyWrapper>(model.Companies.Select(e => new CompanyWrapper(e)));
