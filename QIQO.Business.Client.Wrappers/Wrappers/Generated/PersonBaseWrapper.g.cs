...
{
	public partial class PersonBaseWrapper : ModelWrapperBase<PersonBase>
	{
		public PersonBaseWrapper(PersonBase model) : base(model)
		{
		}
	...
	protected override void InitializeComplexProperties(PersonBase model)
	{
	...
	protected override void InitializeCollectionProperties(PersonBase model)
	{
