...
{
	public partial class VendorRepresentativeWrapper : ModelWrapperBase<VendorRepresentative>
	{
		public VendorRepresentativeWrapper(VendorRepresentative model) : base(model)
		{
		}
	...
	public VendorWrapper Vendor { get; private set; } 
	...
	protected override void InitializeComplexProperties(VendorRepresentative model)
	{
	  ...
	  Vendor = new VendorWrapper(model.Vendor);
	  RegisterComplex(Vendor);
	...
	protected override void InitializeCollectionProperties(VendorRepresentative model)
	{
